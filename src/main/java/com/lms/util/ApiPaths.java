...
public final class ApiPaths {
	...
	public static final class NewCtrl {
		public static final String CTRL = BASE_PATH + "/new";
	}

	public static final class ReviewCtrl {
		public static final String CTRL = BASE_PATH + "/review";
	}

	public static final class BorrowCtrl {
		public static final String CTRL = BASE_PATH + "/borrow";
	}
